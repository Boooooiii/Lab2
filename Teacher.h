...
class Teacher
{
  public:
     ...
     */
    explicit Teacher(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit Teacher(const Json::Value &pJson) noexcept(false);
     ...
     */
    Teacher(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  private:
    ...
    friend drogon::orm::BaseBuilder<Teacher, true, false>;
    friend drogon::orm::BaseBuilder<Teacher, false, true>;
    friend drogon::orm::BaseBuilder<Teacher, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<Teacher>;
#endif
  ...
  public:
    ...
    {
        static const std::string sql="select * from " + tableName + " where teacher_id = $1";
        return sql;
    }

    static const std::string &sqlForDeletingByPrimaryKey()
    {
        static const std::string sql="delete from " + tableName + " where teacher_id = $1";
        return sql;
    }
